...
def banner():
    ...
    print WW+"  |            MOD BY: MR.KRITAN           |"

    print GL+"  |       THE LEGEND BOY MR.KRITAN       |"

    print WW+"  |        FACEBOOK: https://www.facebook.com/MR.KRITAN77            |"

    print Y+"  |             GITHUB: KRITANGAUTAM7       |"
